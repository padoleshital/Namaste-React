    ...
    return (
        <div className='Header'>
            <div className='logo-container'>
                <img className='logo' src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.png" alt='food-logo'/>
            </div>
...
//reastorent Array of object list
...
//Restaurant card component for each restaurant card
 const RestaurantCard = (props) =>{
    const {resData} = props;
    const {cloudinaryImageId, name, costForTwoString,cuisines,avgRating,maxDeliveryTime} = resData?.data;
    // const RestaurantCard = ({resName,cuisines}) => {  Destructuring props
    // const {resName,cuisines} = props;
    // console.log(props,"Props")
    return(
        //  static Restaurant card with static info

        // <div className='restaurant-card'>
        //    <img className='rest-image' alt="chicken-biryani" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/" + resData.data.cloudinaryImageId }/>
        //     <div className='rest-info'>
        //         <h2>{resData.data.name}</h2>     
        //         <p>{resData.data.costForTwoString}</p>
        //         <p>{resData.data.cuisines.join(", ")}</p>
        //         <p>{resData.data.avgRating} star</p>
        //         <p>{resData.data.maxDeliveryTime} min</p>
        //     </div>
        // </div>

        <div className='restaurant-card'>
        <img className='rest-image' alt="chicken-biryani" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/" + cloudinaryImageId }/>
        <div className='rest-info'> 
    ...
    return(
        <div className='Body'>             
             <div className='restaurant-container'> 
                {
                    restaurantList.map(restaurant => <RestaurantCard key={restaurant.data.key} resData ={restaurant}/>)            
                 }            
             </div>
        </div>
        )
